...
class DistributorUserRepository extends MainRepository {

    public function __construct(DistributorUser $distributorUser) {
        parent::__construct($distributorUser);
    }
    ...
    public function index($input = null) {
        $items = $this->model
            ...
            ->StringFilterOn($input, 'sub_distributor_name')
