...
trait VgnControllerTrait {
    ...
    public function store(Request $request) {
        ...
        try {
            ...
            DB::commit();
            if($this->enableQueryLog()) { Log::alert(DB::getQueryLog()); }
            return Vgn::storeResponse($request, ['data' => $item]);
        } catch(\Exception $e) {
            DB::rollBack();
            return Vgn::errorResponse($request, $e);
        }
    }
    ...
    public function update(Request $request, $id) {
        ...
        try {
            ...
            DB::commit();
            if($this->enableQueryLog()) { Log::alert(DB::getQueryLog()); }
            return Vgn::updateResponse($request, ['data' => $item]);
        } catch(\Exception $e) {
            DB::rollBack();
            return Vgn::errorResponse($request, $e);
        }
    ...
    public function show(Request $request, $id) {
        ...
        if($this->enableQueryLog()) { Log::alert(DB::getQueryLog()); }
        return Vgn::showResponse($request, ['data' => $item]);
    }
    ...
    public function destroy(Request $request, $id) {
        ...
        try {
            ...
            DB::commit();
            if($this->enableQueryLog()) { Log::alert(DB::getQueryLog()); }
            return Vgn::deleteResponse($request, ['message' => 'Deleted Successfully.']);
        } catch(\Exception $e) {
            DB::rollBack();
            return Vgn::errorResponse($request, $e);
        }
    ...
    public function multiDestroy(Request $request) {
        ...
        try {
            ...
            DB::commit();
            if($this->enableQueryLog()) { Log::alert(DB::getQueryLog()); }
            return Vgn::deleteResponse($request, ['message' => 'Deleted all Selected Records Successfully.']);
        } catch(\Exception $e) {
            DB::rollBack();
            return Vgn::errorResponse($request, $e);
        }
