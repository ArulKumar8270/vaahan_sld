...
use App\Traits\SubDistributorTrait;

class SubDistributor extends MainModel
{
    use SoftDeletes,SubDistributorTrait;

    protected $table = 'subDistributor';

    protected $isCachable = false;
    protected $cachePrefix = "subDistributor";
